                    ...
                    <div className="flex items-center gap-4">
                        {isLoggedIn ? (
                                    ...
                                    >
                                        <div className="p-2">
                                            ...
                                            <Link href="/perfil" className="flex items-center gap-3 px-3 py-2 text-sm text-gray-700 rounded-md hover:bg-gray-100">
                                             ...
                                             <Link href="/" className="flex items-center gap-3 px-3 py-2 text-sm text-gray-700 rounded-md hover:bg-gray-100">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Link href="/register" className="px-4 py-2 rounded-lg bg-green-600 text-white text-sm font-semibold hover:bg-green-700 transition-colors shadow-sm hover:shadow-md">
                                    Criar Conta
                                </Link>
                            </div>
                        )}
